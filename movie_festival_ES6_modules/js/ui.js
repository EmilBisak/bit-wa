  ...
  const updateMovieList = (movie, index) => {
  ...
  const updateProgramList = (program, index) => {
  ...
  const updateProgramData = (program, oldProgramData) => {
